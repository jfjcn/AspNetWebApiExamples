...
namespace SpecsForWebApiExamples.CDCollection
{
    ...
    public class When_using_the_album_api
    {
        ...
        protected static RestClientForTesting<Album> _albumRestClient;
        protected static RestClientForTesting<Artist> _artistRestClient;
        ...
        {
            _albumRestClient = new RestClientForTesting<Album>(BaseUrl);
            _artistRestClient = new RestClientForTesting<Artist>(BaseUrl);
        }

        [Test]
        public void _001_there_should_be_no_albums_in_the_API()
        {
            var response = _albumRestClient.GetMany(AlbumRelativePath);
        ...
        public void _020_we_should_be_able_to_find_an_album_titled_Raising_Snd_from_our_API()
        {
            ...
            var response = _albumRestClient.GetSingle(AlbumRelativePath + "?albumTitle=" + raisingSandAlbumTitle);
        ...
        public void _030_we_should_be_able_to_rename_our_album_titled_Raising_Sand_to_the_correct_spelling_in_our_API()
        {
            ...
            var response = _albumRestClient.GetSingle(AlbumRelativePath + "?albumTitle=" + raisingSandAlbumTitleMisspelled);
            var raisingSand = response.ReturnedObject;
            Assert.That(raisingSand, Is.Not.Null);
            ...
            var thirdResponse = _albumRestClient.GetSingle(AlbumRelativePath + "/" + raisingSand.Id);
